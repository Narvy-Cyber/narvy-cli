"""Usage-context classifier for the `android-weak-prng` rule (CWE-338): re-grade every
match into security (HIGH), non_security (INFO) or unknown (LOW) from file evidence. Nothing is dropped."""
