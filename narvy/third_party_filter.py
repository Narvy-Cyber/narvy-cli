"""Decide whether a source file is the app's own code or third-party SDK code.
Prefers an own-package allowlist from the manifest, falling back to a denylist of known SDK namespaces."""
