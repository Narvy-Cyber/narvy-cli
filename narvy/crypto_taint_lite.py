"""Name-based correlation pass for hardcoded key and IV material reaching
javax.crypto.spec.{SecretKeySpec,IvParameterSpec} through one level of
indirection. Correlation is by variable name within a single file, not scope.
"""
