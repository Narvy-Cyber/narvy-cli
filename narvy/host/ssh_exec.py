"""Agentless SSH exec helper for host audits, built on the system ssh client.
Private keys go to a 0600 temp file wiped after use; hostname/user are validated
before argv is built; host keys use a per-call known_hosts file."""
