"""Test/fixture paths must not produce headline CRITICAL/HIGH: framework test
suites and fixture apps (the innerHTML/XSS flood) are lowered to LOW, while a
real app-level finding outside test paths keeps its severity.
"""
