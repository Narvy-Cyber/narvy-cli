"""Android findings must never land inside a known third-party SDK namespace.
...
def check_apk(apk_path):
    """Returns a list of (finding, engine) tuples that leaked into a
    third-party namespace - empty list means clean."""
    leaks = []
