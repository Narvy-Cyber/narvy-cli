"""Precision guards for the Android name-based hardcoded-secret rules:
preference-key-name literals and class/type names must not read as secrets,
a real embedded secret must still fire, and test-path hits are down-ranked.
"""
