"""Host checks and Lynis parser, run against a fake probe runner (no SSH)."""
import os
import sys
...
class FakeRun:
    """Map a shell command to a canned Probe by substring; unmatched returns rc=1."""
...
# --- run_checks resilience and counts ---
