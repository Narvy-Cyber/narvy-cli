"""Android SCA reporting: the OSV detail-query cap must be reflected in the
reported counts and surfaced by the CLI. Fully offline.
"""
...
class _StubSession:
    """Answers /querybatch and /query from a fixed vulnerable set and records
    everything asked over the wire."""
